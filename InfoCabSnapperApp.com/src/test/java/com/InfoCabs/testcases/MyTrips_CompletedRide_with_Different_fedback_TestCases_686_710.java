...
public class MyTrips_CompletedRide_with_Different_fedback_TestCases_686_710 extends TestBase {
	...
	public void Test_MyTrips_CompletedRide_with_Different_fedback_Check_for_index1_CancelRide_Option_704(
	...
	@Test(priority = 705)
	@Parameters("CommonLocator")
	public void Test_MyTrips_CompletedRide_with_Different_fedback_CheckPickoff_Address_705(String CommonLocator) {
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
	...
	@Test(priority = 706)
	@Parameters("CommonLocator")
	public void Test_MyTrips_CompletedRide_with_Different_fedback_CheckDropOff_Address_706(String CommonLocator) {
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
	...
	@Test(priority = 707)
	@Parameters("CommonLocator")
	public void Test_MyTrips_CompletedRide_with_Different_fedback_Date_and_Time_707(String CommonLocator) {
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
	...
	@Test(priority = 708)
	@Parameters("CommonLocator")
	public void Test_MyTrips_Cancelled_Ride_And_Rebook_Check_for_Cancelled_Text_and_Button_708(String CommonLocator)
			throws InterruptedException {
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
		boolean ImageLogo = driver.findElement(By.id(CommonLocator + "rbTripRating")).isDisplayed();
		boolean expected = true;
		Assert.assertEquals(ImageLogo, expected);
	}
	...
	@Test(priority = 709)
	@Parameters("CommonLocator")
	public void Test_MyTrips_Cancelled_Ride_And_Rebook_Check_for_Amount_Text_and_Button_709(String CommonLocator)
			throws InterruptedException {
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
		boolean ImageLogo = driver.findElement(By.id(CommonLocator + "tvTripPrice")).isDisplayed();
		boolean expected = true;
		Assert.assertEquals(ImageLogo, expected);
	}
	...
	public void Test_MyTrips_Cancelled_Ride_And_Rebook_ClickOn_Price_Button_710(String CommonLocator, String DropoffAddress)
		...
		HelperMethods.waitForPageLoaded();
		driver.hideKeyboard();
		WebElement L5 = driver.findElement(By.id(CommonLocator + "tvTripPrice"));
		WebDriverWait wait = new WebDriverWait(driver, 40);
