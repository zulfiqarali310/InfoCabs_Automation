...
public class Share_Page_TestCases_667_668 extends TestBase {

	HelperMethods HelpMethod = new HelperMethods();

	@Test(priority = 667)
	@Parameters({ "CommonLocator", "Sidermenue_CommonText" })
	public void Test_Share_Page_ClickTO_Open_Share_Page_667(String CommonLocator, String Sidermenue_CommonText) {
	...
	public void Test_Share_Page_check_ShareText_is_present_668(String CommonLocator, String CommonLocator_ClassView,
		...
		if (L1.isDisplayed()) {
			...
			System.out.println("Test:668, admin@hollywoodcars.co.uk email is not present");
		}
