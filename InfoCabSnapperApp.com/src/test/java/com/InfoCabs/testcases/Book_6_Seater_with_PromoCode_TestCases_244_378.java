...
public class Book_6_Seater_with_PromoCode_TestCases_244_378 extends TestBase{
	...
	public void Test_Book_6_Seater_with_PromoCode_EnterDropofAddress_Cab_344(String CommonLocator, String DropoffAddress) throws InterruptedException {
		HelperMethods.waitForPageLoaded();
		Thread.sleep(4000);
		driver.hideKeyboard();
	...
	@Test(priority = 376)
	@Parameters("CommonLocator_ClassView")
	public void Test_Book_6_Seater_with_PromoCode_Rate_your_ride_Text_arePresent_376(String CommonLocator_ClassView) throws InterruptedException {
		HelperMethods.waitForPageLoaded();
		Thread.sleep(4000);
		driver.hideKeyboard();
